            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 text-gray-900">
                ...
                <form action="{{ route('mahasiswas.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nim" value="{{ old('nim') }}" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm w-full" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama_mahasiswa" value="{{ old('nama_mahasiswa') }}" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm w-full" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="tempat_lahir" value="{{ old('tempat_lahir') }}" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm w-full" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" name="tanggal_lahir" value="{{ old('tanggal_lahir') }}" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm w-full" required>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="alamat" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm w-full" required>{{ old('alamat') }}</textarea>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="program_studi" value="{{ old('program_studi') }}" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm w-full" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nomor_hp" value="{{ old('nomor_hp') }}" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm w-full" required>
                        @error('nomor_hp') <span class="text-red-600 text-sm">{{ $message }}</span> @enderror
                    </div>

                    <div class="mb-4">
                        <label class="block font-medium text-sm text-gray-700">Email</label>
                        <input type="email" name="email" value="{{ old('email') }}" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm w-full" required>
